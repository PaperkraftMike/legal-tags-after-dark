...
export default function NightOwlPaymentPlan() {
  ...
  const navigateToStep = (targetStep) => {
    ...
    setStep(targetStep);
    clarityEvent(`nightowl_payment_step_${stepNames[targetStep] || targetStep}`);
  };
  ...
  const handlePrev = () => {
    if (stepHistory.length > 1) {
      ...
      setStep(toStep);
      clarityEvent('nightowl_payment_back', `${stepNames[fromStep] || fromStep}_to_${stepNames[toStep] || toStep}`);
    }
  };
  ...
  const handleRadioSelect = (field, value) => {
    if (!hasInteracted) {
      ...
      clarityEvent('nightowl_payment_survey_started');
    }
    clarityEvent(`nightowl_payment_answer_${field}`, value);
  ...
  const handleSubmit = (e) => {
    ...
    const webhookPayload = {
      ...
      source: 'legaltags_nightowl_payment',
      offer_type: 'nightowl_199_start',
      event_id: eventId,
    ...
    // Clarity events
    clarityEvent('nightowl_payment_survey_complete', {
      vehicle_type: formData.vehicleType,
      has_title: formData.hasTitle,
      vehicle_age: formData.vehicleAge,
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <span>🌙 $199 START PAYMENT PLAN EXPIRES IN</span>
      ...
      <header style={{
        ...
        <a href="tel:406-510-0599" className="mono" onClick={() => clarityEvent('nightowl_payment_phone_click')} style={{ fontSize: '13px', color: '#c9a227', textDecoration: 'none', fontWeight: '500' }}>
          📞 406-510-0599
        </a>
      </header>
      ...
      <section style={{ padding: '32px 20px 0', textAlign: 'center' }}>
        <div style={{ maxWidth: '500px', margin: '0 auto' }}>
          ...
          <h1 className="condensed" style={{
            ...
            Start For Just<br/><span style={{ color: '#c9a227' }}>$199 Tonight</span>
          </h1>
          ...
          <p className="mono" style={{ fontSize: '12px', color: '#c9a227', fontWeight: '500' }}>
            Night Owl payment plan · Lock in tonight, pay the rest later
          </p>
            ...
            {step === 0 && (
              <div>
                <h2 className="condensed" style={{ fontSize: '20px', fontWeight: '700', textAlign: 'center', marginBottom: '16px', color: '#e8e4d9' }}>
                  Complete the survey now to lock in the <span style={{ color: '#c9a227' }}>$199 start tonight</span> payment plan.
                </h2>
              ...
              <div>
                ...
                <select className="form-input" value={formData.truckSize}
                  onChange={(e) => {
                    ...
                    if (!hasInteracted) { setHasInteracted(true); clarityEvent('nightowl_payment_survey_started'); }
                    clarityEvent('nightowl_payment_answer_truckSize', val);
            ...
            {step === 7 && (
              <div>
                ...
                <select className="form-input" value={formData.isSalvage}
                  onChange={(e) => {
                    const val = e.target.value;
                    clarityEvent('nightowl_payment_answer_isSalvage', val);
            ...
            {step === 8 && (
              <div>
                ...
                <select className="form-input" value={formData.salvageClassification}
                  onChange={(e) => {
                    const val = e.target.value;
                    clarityEvent('nightowl_payment_answer_salvageClassification', val);
            ...
            {step === 11 && (
              <div>
                <h2 className="condensed" style={{ fontSize: '20px', fontWeight: '700', textAlign: 'center', marginBottom: '8px', color: '#e8e4d9' }}>
                  Last step to lock in your <span style={{ color: '#c9a227' }}>$199 payment plan!</span>
                </h2>
                <p style={{ marginBottom: '20px', fontSize: '14px', color: '#999', textAlign: 'center' }}>
        ...
        <div style={{ maxWidth: '700px', margin: '0 auto' }}>
          ...
          <div className="process-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '24px' }}>
            {[
              ...
              { num: '2', title: 'We Create Your LLC', desc: 'We set up your Montana LLC same-day (start for $199, pay the rest later)' },
      ...
      <section className="section" style={{ textAlign: 'center', background: '#0d0d1a' }}>
        <div style={{ maxWidth: '500px', margin: '0 auto', padding: '0 20px' }}>
          ...
          <p className="mono" style={{ fontSize: '12px', color: '#666', marginBottom: '32px' }}>
            Start for just $199 tonight. Pay the rest on your schedule.
          </p>
          <button className="btn-primary" style={{ maxWidth: '320px' }}
            onClick={() => {
              clarityEvent('nightowl_payment_cta_guarantee');
